...
class TransferAdmin(admin.ModelAdmin):
    ...
    list_display = (
        'transfer_location', 'pickup_date', 'pickup_time', 'return_location', 'return_date', 'return_time',
        'with_driver')
    list_filter = ('transfer_location', 'pickup_date', 'return_location', 'return_date', 'different_pickup_places')
