    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pickup_date', models.DateField(validators=[django.core.validators.MinValueValidator(datetime.date(2023, 8, 7))], verbose_name='Дата получения трансфера')),
                ...
                ('return_date', models.DateField(validators=[django.core.validators.MinValueValidator(datetime.date(2023, 8, 7))], verbose_name='Дата возврата трансфера')),
