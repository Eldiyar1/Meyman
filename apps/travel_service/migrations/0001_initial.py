    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(choices=[('Bishkek', 'Бишкек'), ('Jalal-Abad', 'Джалал-Абад'), ('Issyk-Kul', 'Иссык-Куль'), ('Osh', 'Ош'), ('Naryn', 'Нарын'), ('Talas', 'Талас'), ('Batken', 'Баткен')], max_length=50, verbose_name='Область нахождения машины')),
                ('car_address', models.CharField(max_length=255, verbose_name='Адрес')),
                ('pickup_region', multiselectfield.db.fields.MultiSelectField(choices=[('Bishkek', 'Бишкек'), ('Jalal-Abad', 'Джалал-Абад'), ('Issyk-Kul', 'Иссык-Куль'), ('Osh', 'Ош'), ('Naryn', 'Нарын'), ('Talas', 'Талас'), ('Batken', 'Баткен'), ('Все', 'Все')], max_length=100, verbose_name='Регион получения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(null=True, upload_to='images/car/', verbose_name='Изображение автомобиля')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pickup_date', models.DateField(validators=[django.core.validators.MinValueValidator(datetime.date(2023, 8, 6))], verbose_name='Дата получения трансфера')),
                ...
                ('return_date', models.DateField(validators=[django.core.validators.MinValueValidator(datetime.date(2023, 8, 6))], verbose_name='Дата возврата трансфера')),
