    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('check_in_date', models.DateField(validators=[django.core.validators.MinValueValidator(datetime.date(2023, 7, 25))], verbose_name='Заезд')),
                ('check_out_date', models.DateField(validators=[django.core.validators.MinValueValidator(datetime.date(2023, 7, 25))], verbose_name='Выезд')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pickup_date', models.DateField(validators=[django.core.validators.MinValueValidator(datetime.date(2023, 7, 25))], verbose_name='Дата получения трансфера')),
                ...
                ('return_date', models.DateField(validators=[django.core.validators.MinValueValidator(datetime.date(2023, 7, 25))], verbose_name='Дата возврата трансфера')),
