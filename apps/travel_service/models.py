...
from apps.travel.constants import PAYMENT_CHOICES, PASSENGER_CAPACITY_CHOICES
...
class Transfer(models.Model):
    ...
    year = models.PositiveIntegerField(choices=YEAR_CHOICES, verbose_name='Год выпуска')
