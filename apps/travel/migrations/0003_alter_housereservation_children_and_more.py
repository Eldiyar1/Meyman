...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('travel', '0002_alter_housing_housing_amenities'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='children',
            field=models.PositiveIntegerField(default=0, verbose_name='Дети(от 2-12 лет)'),
        ),
        migrations.AlterField(
            model_name='housereservation',
            name='housing',
        ...
        migrations.AlterField(
            model_name='housereservation',
            name='infants',
            field=models.PositiveIntegerField(default=0, verbose_name='Младенцы(младше 2)'),
        ),
        migrations.AlterField(
            model_name='housereservation',
            name='pets',
            field=models.PositiveIntegerField(default=0, verbose_name='Домашние животные'),
        ),
        migrations.AlterField(
            model_name='housereservation',
            name='teens',
            field=models.PositiveIntegerField(default=0, verbose_name='Подростки(от 13-18 лет)'),
        ),
        migrations.AlterField(
            model_name='housing',
            name='breakfast_type',
            field=multiselectfield.db.fields.MultiSelectField(blank=True, choices=[('Asian', 'Азиатский'), ('Continental', 'Континентальный'), ('Swedish', 'Шведский')], default=1, max_length=100, verbose_name='Какой тип завтрака вы предлагаете?'),
