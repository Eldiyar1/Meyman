    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('check_in_date', models.DateField(validators=[django.core.validators.MinValueValidator(datetime.date(2023, 8, 23))], verbose_name='Заезд')),
                ('check_out_date', models.DateField(validators=[django.core.validators.MinValueValidator(datetime.date(2023, 8, 23))], verbose_name='Выезд')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_amenities', multiselectfield.db.fields.MultiSelectField(choices=[('Двуспальная кровать', 'Двуспальная кровать'), ('Кондиционер', 'Кондиционер'), ('Тумба', 'Тумба'), ('Телевизор', 'Телевизор'), ('Стиральная машина', 'Стиральная машина'), ('Ванная комната', 'Ванная комната'), ('Утюг', 'Утюг'), ('2 комнаты', '2 комнаты'), ('Холодильник', 'Холодильник'), ('Фен', 'Фен'), ('Сейф', 'Сейф'), ('Телефон', 'Телефон'), ('Комоды', 'Комоды'), ('Шкафы', 'Шкафы'), ('Мини кухня', 'Мини кухня'), ('Тапочки', 'Тапочки'), ('Халат', 'Халат'), ('Закуски', 'Закуски'), ('Камин', 'Камин')], max_length=100, verbose_name='Удобства')),
                ('kitchen', multiselectfield.db.fields.MultiSelectField(choices=[('чайник', 'Электронный чайник'), ('микроволновка', 'Микроволновка'), ('обеденный_стол', 'Обеденный стол'), ('кофеварка', 'Кофеварка'), ('mini_bar', 'Mini-bar'), ('холодильник', 'Холодильник')], max_length=100, verbose_name='Кухня')),
                ('amenities', multiselectfield.db.fields.MultiSelectField(choices=[('Балкон', 'Балкон'), ('Терраса', 'Терраса'), ('Вид из окна', 'Вид из окна')], max_length=100, verbose_name='На улице')),
                ('bathroom', multiselectfield.db.fields.MultiSelectField(choices=[('Душ', 'Душ'), ('Туалетная бумага', 'Туалетная бумага'), ('Туалет', 'Туалет'), ('Фен', 'Фен'), ('Ванна', 'Ванна'), ('Бесплатные уходовые средства', 'Бесплатные уходовые средства'), ('Биде', 'Биде'), ('Тапочки', 'Тапочки'), ('Халат', 'Халат')], max_length=100, verbose_name='Ванная')),
