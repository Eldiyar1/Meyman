...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rating', models.CharField(choices=[('Замечательно', '9+: Замечательно'), ('Отлично', '8+: Отлично'), ('Хорошо', '7+: Хорошо'), ('Неплохо', '5+: Неплохо'), ('Не оценено', 'Не оценено')], default='Не оценено', max_length=20, verbose_name='Рейтинг')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('housing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='house_images', to='travel.housing')),
            ],
            options={
                'verbose_name': 'Изображение места жительства',
                'verbose_name_plural': 'Изображения места жительства',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('housing', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='travel.housing', verbose_name='Жилье')),
            ],
            options={
